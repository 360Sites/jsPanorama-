...
ParticleEngine.prototype.initialize = function()
{
	...
	this.particleMesh = new THREE.Mesh( sphere_geometry, normal);
...
// add it to the PANORAMA.scene()
PANORAMA.scene().add(particleSystem);
	*/
	
	
	PANORAMA.scene().add( this.particleMesh );
}
...
{
    PANORAMA.scene().remove( this.particleMesh );
}
///////////////////////////////////////////////////////////////////////////////
